...
var petfinder = (0, _petfinderClient.default)({
  key: "a602ccffeffa57cbe5b8724a26d1f022",
  secret: "584a579d1bd20acfa074b6f145bf3ea3"
});
    ...
    value: function render() {
      return _react.default.createElement("div", {
        ...
        return _react.default.createElement(_Pet.default, {
          ...
          breed: breed,
          media: pet.media,
          location: "".concat(pet.contact.city, ", ").concat(pet.contact.state, ", ").concat(pet.contact.phone)
        });
      }));
    }
  }]);
